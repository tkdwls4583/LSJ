...
{
    public partial class modify_popup : Form
    {
        public modify_popup()
        {
            InitializeComponent();
        ...
        private void modify_popup_Load(object sender, EventArgs e)
        {
            textBox1.Text = Menu_modify_popup.menu_Modify_Popup.Sp[0];
        }
        ...
        private void button1_Click(object sender, EventArgs e) //수정완료 버튼
        {
            product product = new product();
            if (Order.order.d == 1)
            {
                product.Drink_Correction(textBox1.Text, textBox3.Text, textBox2.Text);
                menuevent();
            }
            else if (Order.order.f == 1)
            {
                product.Food_Correction(textBox1.Text, textBox3.Text, textBox2.Text);
                menuevent_F();
            }
            else if (Order.order.t == 1)
            {
                product.Thing_Correction(textBox1.Text, textBox3.Text, textBox2.Text);
                menuevent_T();
            }
            Order.order.sales.LoadProducts();
        }
        ...
        private void modify_popup_MouseUp(object sender, MouseEventArgs e)
        {
            onClick = false;
        }
    }
